...
Revision ID: 003495c5f0c7
Revises: 7fb59e922a17
Create Date: 2026-03-07 22:54:38.313289
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('user_id', 'github_user_id', name='uq_github_account_user_gh')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'github_repo_id', name='uq_project_repo')
    )
