# Layout Redesign — Plan 04: Home Dashboard

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Replace the current Home screen (project list) with a cross-project dashboard showing needs attention, running sessions, and recent activity — all with mock data.

**Architecture:** Static mock data arrays rendered as bento grid sections. No API integration yet. Click handlers navigate to project + ticket using project nav store and tab store.

**Tech Stack:** React, Tailwind CSS, Lucide icons, `@agent-coding/ui` (ScrollArea, StatusBadge)

**Depends on:** Plan 01 (needs `useProjectNavStore`, scoped tab store)
**Blocks:** Nothing

**Ref:** `docs/plans/2026-03-08-layout-redesign-design.md` §2 (Home Dashboard)

---

## Task 1: Rewrite Home Screen

**Files:**
- Modify: `apps/desktop/src/renderer/screens/home.tsx`

**Step 1: Rewrite with mock dashboard**
...
git commit -m "feat: replace home screen with dashboard (mock data)"
```
